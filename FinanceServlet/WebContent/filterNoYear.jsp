...
<%}else{if(flag.equals((String)"deposit")){for (int i=0;i<a.getDepositHistory().size();i++){%><br>
	<% out.println(a.getDepositHistory().get(i).getTransaction()+" "+a.getDepositHistory().get(i).getAmount()
...
<%}else{for (int i=0;i<a.getCheckHistory().size();i++){ %><br>
	<% out.println(a.getCheckHistory().get(i).getTransaction()+" "+a.getCheckHistory().get(i).getAmount()
